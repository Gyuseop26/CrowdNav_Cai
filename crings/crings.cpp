 ...
 */
      __pyx_t_10 = __pyx_v_range_idx;
      __pyx_t_9 = -1;
      if (__pyx_t_10 < 0) {
        __pyx_t_10 += __pyx_v_range_level_maxs.shape[0];
        if (unlikely(__pyx_t_10 < 0)) __pyx_t_9 = 0;
      } else if (unlikely(__pyx_t_10 >= __pyx_v_range_level_maxs.shape[0])) __pyx_t_9 = 0;
      if (unlikely(__pyx_t_9 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_9);
        __PYX_ERR(0, 48, __pyx_L1_error)
      }
      __pyx_v_r_max = (*((__pyx_t_5numpy_float32_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5numpy_float32_t *) __pyx_v_range_level_maxs.data) + __pyx_t_10)) )));
 ...
 *                     if dist == 0:
 */
        __pyx_t_13 = __pyx_v_ray_idx_end;
        __pyx_t_14 = __pyx_t_13;
        for (__pyx_t_15 = __pyx_v_ray_idx_start; __pyx_t_15 < __pyx_t_14; __pyx_t_15+=1) {
          __pyx_v_ray_idx = __pyx_t_15;
 ...
 *                         continue
 */
          __pyx_t_16 = __pyx_v_scan_idx;
          __pyx_t_17 = __pyx_v_ray_idx;
          __pyx_t_18 = -1;
          if (__pyx_t_16 < 0) {
            __pyx_t_16 += __pyx_v_scans.shape[0];
            if (unlikely(__pyx_t_16 < 0)) __pyx_t_18 = 0;
          } else if (unlikely(__pyx_t_16 >= __pyx_v_scans.shape[0])) __pyx_t_18 = 0;
          if (__pyx_t_17 < 0) {
            __pyx_t_17 += __pyx_v_scans.shape[1];
            if (unlikely(__pyx_t_17 < 0)) __pyx_t_18 = 1;
          } else if (unlikely(__pyx_t_17 >= __pyx_v_scans.shape[1])) __pyx_t_18 = 1;
          if (unlikely(__pyx_t_18 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_18);
            __PYX_ERR(0, 54, __pyx_L1_error)
          }
          __pyx_v_dist = (*((__pyx_t_5numpy_float32_t *) ( /* dim=1 */ ((char *) (((__pyx_t_5numpy_float32_t *) ( /* dim=0 */ (__pyx_v_scans.data + __pyx_t_16 * __pyx_v_scans.strides[0]) )) + __pyx_t_17)) )));
 ...
 *                         break
 */
          __pyx_t_20 = ((__pyx_v_r_min <= __pyx_v_dist) != 0);
          if (__pyx_t_20) {
          } else {
            __pyx_t_19 = __pyx_t_20;
            goto __pyx_L13_bool_binop_done;
          }
          __pyx_t_20 = ((__pyx_v_dist < __pyx_v_r_max) != 0);
          __pyx_t_19 = __pyx_t_20;
 ...
 *                         continue
 */
          __pyx_t_19 = ((__pyx_v_dist < __pyx_v_r_min) != 0);
          if (__pyx_t_19) {
 ...
 *                 rings[scan_idx, angle_idx, range_idx, CHANNEL] = cell_value             # <<<<<<<<<<<<<<
 */
        __pyx_t_21 = __pyx_v_scan_idx;
        __pyx_t_22 = __pyx_v_angle_idx;
        __pyx_t_23 = __pyx_v_range_idx;
        __pyx_t_24 = __pyx_v_CHANNEL;
        __pyx_t_13 = -1;
        if (__pyx_t_21 < 0) {
          __pyx_t_21 += __pyx_v_rings.shape[0];
          if (unlikely(__pyx_t_21 < 0)) __pyx_t_13 = 0;
        } else if (unlikely(__pyx_t_21 >= __pyx_v_rings.shape[0])) __pyx_t_13 = 0;
        if (__pyx_t_22 < 0) {
          __pyx_t_22 += __pyx_v_rings.shape[1];
          if (unlikely(__pyx_t_22 < 0)) __pyx_t_13 = 1;
        } else if (unlikely(__pyx_t_22 >= __pyx_v_rings.shape[1])) __pyx_t_13 = 1;
        if (__pyx_t_23 < 0) {
          __pyx_t_23 += __pyx_v_rings.shape[2];
          if (unlikely(__pyx_t_23 < 0)) __pyx_t_13 = 2;
        } else if (unlikely(__pyx_t_23 >= __pyx_v_rings.shape[2])) __pyx_t_13 = 2;
        if (__pyx_t_24 < 0) {
          __pyx_t_24 += __pyx_v_rings.shape[3];
          if (unlikely(__pyx_t_24 < 0)) __pyx_t_13 = 3;
        } else if (unlikely(__pyx_t_24 >= __pyx_v_rings.shape[3])) __pyx_t_13 = 3;
        if (unlikely(__pyx_t_13 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_13);
          __PYX_ERR(0, 65, __pyx_L1_error)
        }
        *((__pyx_t_5numpy_uint8_t *) ( /* dim=3 */ ((char *) (((__pyx_t_5numpy_uint8_t *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_rings.data + __pyx_t_21 * __pyx_v_rings.strides[0]) ) + __pyx_t_22 * __pyx_v_rings.strides[1]) ) + __pyx_t_23 * __pyx_v_rings.strides[2]) )) + __pyx_t_24)) )) = __pyx_v_cell_value;
      }
    }
  }
